    ...
    <DndProvider backend={HTML5Backend}>
      <div className="mx-auto py-4 relative h-screen flex flex-col overflow-hidden">
        ...
        <div className="flex flex-1 overflow-hidden">
          <div className={`flex-1 overflow-y-auto p-4 pb-20 ${isSidebarCollapsed ? 'ml-[64px]' : 'ml-[240px]'} transition-all duration-300`}>
            <div className="grid gap-8">
              {courts.map((court) => (
                <Court
                  ...
                  onChangePersonCourt={handleChangePersonCourt}
                  programs={programs}
                />
              ))}
            </div>
          ...
          <div className="fixed right-0 top-[250px] bottom-0 w-80 bg-white border-l border-gray-200 p-4 overflow-y-auto z-40">
            <div className="space-y-4">
              <AvailablePeople 
                people={people}
                onDrop={handleDrop}
