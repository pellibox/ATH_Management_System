...
import { Plus, Trash2, Edit, Save, ArrowUp, ArrowDown, ChevronDown, ChevronUp } from "lucide-react";
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center">
            <CollapsibleTrigger className="mr-2 p-1 hover:bg-gray-100 rounded-md">
